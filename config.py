...
def param_init(param):
    ...
    if case == 6:    
        seed_training = 15485179          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 15485251
        param["seed_simulation"] = seed_simulation
    ...
    if case == 7:    
        seed_training = 1005485179          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 1548525001
        param["seed_simulation"] = seed_simulation
    ...
    if case == 8:    
        seed_training = 15484999          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 15485077
        param["seed_simulation"] = seed_simulation
    ...
    if case == 9:    
        seed_training = 10377533          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 10377683
        param["seed_simulation"] = seed_simulation
    ...
    if case == 10:    
        #minic case 4
        seed_training = 10372541          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 10372421
        param["seed_simulation"] = seed_simulation
    ...
    if case == 11:    
        #minic case 4
        seed_training = 10352717          
        np.random.seed(seed_training)
        param["seed_training"] = seed_training
        
        seed_simulation = 10352611
        param["seed_simulation"] = seed_simulation
    ...
    #tensorflow model
    fname_tensorflow_model = "".join([model_path, "dpdnn.ckpt"])
